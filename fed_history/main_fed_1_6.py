...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        for idx in range(args.num_users): # 所有客户并行训练
            ...
            if iter == 0 and idx==idxs_users[0] and args.save==True:
                ...
                np.savetxt("./savedata/delta_w_round{}.txt".format(iter),delta_ww)
            ...
            for idx_key in key: # 对每一层进行运算
                ...
                if var_expe_w[idx_key] <= G or not(args.an):
                    ...
                    # MODIFY
                    sigma[idx_key] = s[idx_key]*sigma_star*(m**0.5)*((1/args.num_users)**0.5)
            ...
            if iter==0 and idx==idxs_users[0] and args.save==True:
                ...
                np.savetxt("./savedata/prior_delta_w_round{}.txt".format(iter),ss/beta)
    ...
    np.savetxt("./savedata/testing_epsilon{}_frac{}_lr{}_nl{}_beta{}_gamma{}_ls{}_lepoch{:.2f}_an{}_iid{}.txt".format(args.epsilon, args.frac, args.lr, args.nl, args.beta, args.gamma_star, args.ls, args.local_ep, args.an, args.iid),y1)
    
    y2 = np.array(acc_train_repro)
    np.savetxt("./savedata/training_epsilon{}_frac{}_lr{}_nl{}_beta{}_gamma{}_ls{}_lepoch{:.2f}_an{}_iid{}.txt".format(args.epsilon, args.frac, args.lr, args.nl, args.beta, args.gamma_star, args.ls, args.local_ep, args.an, args.iid),y2)
