    ...
    for idx in range(args.num_users):  # 所有客户并行训练
        ...
        for idx_key in key:  # 对每一层进行运算
            ...
            if var_expe_w[idx_key] <= G or not (args.an):
                ...
                delta_w[idx_key] = delta_w[idx_key] + torch.normal(0, C * sigma_0, delta_w[idx_key].size()).to(args.device)


            else:
                s[idx_key] = beta * torch.sqrt(Expectation_g_2_local[idx_key] / (gamma_prime * Expectation_g_2_local[idx_key] + 1e-8))
...
# np.savetxt(
#     "./savedata/delta_epsilon{}_frac{}_lr{}_nl{}_beta{}_gamma{}_ls{}_lepoch{:.2f}_an{}_iid{}.txt".format(args.epsilon,
#                                                                                                           args.frac,
#                                                                                                           args.lr,
#                                                                                                           args.nl,
#                                                                                                           args.beta,
...
# np.savetxt(
#     "./savedata/training_epsilon{}_frac{}_lr{}_nl{}_beta{}_gamma{}_ls{}_lepoch{:.2f}_an{}_iid{}.txt".format(args.epsilon,
#                                                                                                            args.frac,
#                                                                                                            args.lr,
#                                                                                                            args.nl,
#                                                                                                            args.beta,
